...
namespace MonitorDriveAPI.Migrations
{
    ...
    [Migration("20240928153528_Seeding data for users")]
            ...
            modelBuilder.Entity("MonitorDriveAPI.Models.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6045),
                            ...
                            Update_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6092)
                        },
                        new
                        {
                            Id = new Guid("3e7be918-25ea-4407-9fcc-a6c0608b71af"),
                            Created_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6100),
                            ...
                            Update_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6101)
                        },
                        new
                        {
                            Id = new Guid("e4eb9db7-793d-41cf-803f-755e7a495ab5"),
                            Created_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6105),
                            ...
                            Update_at = new DateTime(2024, 9, 28, 11, 35, 27, 860, DateTimeKind.Local).AddTicks(6106)
                        });
                });
